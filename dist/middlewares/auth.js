...
import { isTokenNearExpiry, reIssueToken, veriftToken, } from "@/helpers/authHelper.js";
...
export const authenticate = (req, res, next) => {
    ...
    try {
        ...
        if (isTokenNearExpiry({ decodedToken })) {
            ...
            res.cookie(sessionCookieName, refreshedToken, getSessionCookieOptions(maxAge));
